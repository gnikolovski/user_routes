...
class SettingsForm extends ConfigFormBase implements ContainerInjectionInterface {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['user_login'] = [
      ...
      '#description' => $this->t('Default route path: /user/login'),
    ];
    ...
    $form['user_register'] = [
      ...
      '#description' => $this->t('Default route path: /user/register'),
    ];
    ...
    $form['user_logout'] = [
      ...
      '#description' => $this->t('Default route path: /user/logout'),
    ];
    ...
    $form['user_pass'] = [
      ...
      '#description' => $this->t('Default route path: /user/password'),
    ];
